...
const StaffManageOrganization = () => {
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      toast.error("Deletion failed: Only the staff advisor can delete this organization.");
    }
  };
    ...
    if (editingOrganization) {
      try {
        ...
        if(newOrg.status === 400) {
          toast.error(newOrg.originalError.message || "Creation failed: An organization can have only one staff advisor.");
          return;
        }
        fetchOrganizations();
        setIsDialogOpen(false);
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="ml-64 mt-16 p-4 md:p-6 bg-gray-100 w-full max-w-full overflow-x-hidden">
...
export default StaffManageOrganization;
